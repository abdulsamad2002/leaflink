  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen bg-emerald-600 flex justify-center items-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-white text-2xl font-light">Loading...</div>
      </div>
    );
  }

  // Show redirecting message when logged in
  if (session || isRedirecting) {
    return (
      <div className="min-h-screen bg-emerald-600 flex justify-center items-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-white text-2xl font-light">Redirecting to dashboard...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-emerald-600 flex justify-center items-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
        <h1 className="text-5xl md:text-4xl font-extrabold text-white mb-6 leading-tight">
        ...
        <button
          className="cursor-pointer group relative px-10 py-4 bg-white text-green-600 rounded-full font-bold text-lg shadow-2xl hover:shadow-green-300/50 transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden"
